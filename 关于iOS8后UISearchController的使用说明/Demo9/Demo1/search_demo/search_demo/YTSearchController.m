...
-(instancetype)initWithSearchView{
    if (self = [super init]) {
        ...
        self = [[YTSearchController alloc] initWithSearchResultsController:nil];
...
//        self.searchBar.backgroundColor = [UIColor greenColor];
        [self.searchBar setBackgroundImage:[self createImageWithColor:[UIColor purpleColor]] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
